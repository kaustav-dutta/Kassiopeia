...
class KG2DPolygon: public KG2DArea
{
    public:
        ...
        static double NearestDistance(const std::vector< KTwoVector >* ordered_vertices,
                                     const KTwoVector& aPoint);

        static KTwoVector NearestPoint(const std::vector< KTwoVector >* ordered_vertices,
                                       const KTwoVector& aPoint);

        static KTwoVector NearestNormal(const std::vector< KTwoVector >* ordered_vertices,
                                        const KTwoVector& aPoint);

        static bool NearestIntersection(const std::vector< KTwoVector >* ordered_vertices,
                                        const KTwoVector& aStart, const KTwoVector& anEnd,
                                        KTwoVector& anIntersection );

        static bool IsInside(const std::vector< KTwoVector >* ordered_vertices, 
