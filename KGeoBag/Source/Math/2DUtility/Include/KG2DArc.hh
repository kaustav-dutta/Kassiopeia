...
class KG2DArc: public KG2DShape
{
    public:
        ...
        ///on the left
        void SetPointsRadiusOrientation(const KTwoVector& point1,
                                        const KTwoVector& point2,
                                        const double& radius,
                                        bool isRight = true,
                                        bool isCCW = true);
        ...
        void SetCenterRadiusAngles(const KTwoVector& center,
                                   const double& radius,
                                   const double& start_angle,
        ...
        void SetStartPointCenterAngle(const KTwoVector& center,
                                      const KTwoVector& point1,
                                      const double& angle);
        ...
        double GetAngleSubtended() const {return fSubtendedAngle;};
        KTwoVector GetFirstPoint() const {return fP1;};
        KTwoVector GetSecondPoint() const {return fP2;};
        double GetAngleFirstPoint() const {return fA1;};
        double GetAngleSecondPoint() const {return fA2;};
        KTwoVector GetCenter() const {return fCenter;};
