...
namespace katrin
{
  ...
  template<>
  inline bool KGLinearWireGridBuilder::AddAttribute(KContainer* anAttribute)
  {
  ...
  template<>
  inline bool KGLinearWireGridSurfaceBuilder::AddAttribute(KContainer* anAttribute)
  {
  ...
  template<>
  inline bool KGLinearWireGridSurfaceBuilder::AddElement(KContainer* anElement)
  {
  ...
  template<>
  inline bool KGLinearWireGridSpaceBuilder::AddAttribute(KContainer* anAttribute)
  {
    if (anAttribute->GetName() == "name")
    {
  ...
  template<>
  inline bool KGLinearWireGridSpaceBuilder::AddElement(KContainer* anElement)
  {
    if (anElement->GetName() == "linear_wire_grid")
    {
      KGLinearWireGrid* object = nullptr;
