...
namespace katrin
{
  ...
  template<>
  inline bool KGCircularWirePinsBuilder::AddAttribute(KContainer* anAttribute)
  {
  ...
  template<>
  inline bool KGCircularWirePinsSurfaceBuilder::AddAttribute(KContainer* anAttribute)
  {
  ...
  template<>
  inline bool KGCircularWirePinsSurfaceBuilder::AddElement(KContainer* anElement)
  {
  ...
  template<>
  inline bool KGCircularWirePinsSpaceBuilder::AddAttribute(KContainer* anAttribute)
  {
    if (anAttribute->GetName() == "name")
    {
  ...
  template<>
  inline bool KGCircularWirePinsSpaceBuilder::AddElement(KContainer* anElement)
  {
    if (anElement->GetName() == "circular_wire_pins")
    {
      KGCircularWirePins* object = nullptr;
