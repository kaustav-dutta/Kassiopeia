...
namespace KGeoBag
{
    ...
    inline bool KGSpace::HasExtension() const
    {
    ...
    template< class XExtension >
    inline const KGExtendedSpace< XExtension >* KGSpace::AsExtension() const
    {
        KGExtensibleSpace* tExtensible;
        KGExtendedSpace< XExtension >* tExtended;
        std::vector< KGExtensibleSpace* >::const_iterator tIt;
    ...
    template< class XExtension >
    inline KGExtendedSpace< XExtension >* KGSpace::AsExtension()
    {
        KGExtensibleSpace* tExtensible;
        KGExtendedSpace< XExtension >* tExtended;
    ...
    template< class XExtension >
    inline KGExtendedSpace< XExtension >* KGSpace::MakeExtension()
    {
        KGExtensibleSpace* tExtensible;
        KGExtendedSpace< XExtension >* tExtended;
        std::vector< KGExtensibleSpace* >::iterator tIt;
