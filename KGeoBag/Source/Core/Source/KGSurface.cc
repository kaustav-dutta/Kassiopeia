...
namespace KGeoBag
{
    ...
    bool KGSurface::Above( const KThreeVector& aQueryPoint ) const
    {
        if( fArea )
        {
            ...
            tLocalQueryPoint[ 0 ] = (aQueryPoint[ 0 ] - fOrigin[ 0 ]) * fXAxis[ 0 ] + (aQueryPoint[ 1 ] - fOrigin[ 1 ]) * fXAxis[ 1 ] + (aQueryPoint[ 2 ] - fOrigin[ 2 ]) * fXAxis[ 2 ];
            tLocalQueryPoint[ 1 ] = (aQueryPoint[ 0 ] - fOrigin[ 0 ]) * fYAxis[ 0 ] + (aQueryPoint[ 1 ] - fOrigin[ 1 ]) * fYAxis[ 1 ] + (aQueryPoint[ 2 ] - fOrigin[ 2 ]) * fYAxis[ 2 ];
            tLocalQueryPoint[ 2 ] = (aQueryPoint[ 0 ] - fOrigin[ 0 ]) * fZAxis[ 0 ] + (aQueryPoint[ 1 ] - fOrigin[ 1 ]) * fZAxis[ 1 ] + (aQueryPoint[ 2 ] - fOrigin[ 2 ]) * fZAxis[ 2 ];
    ...
    KThreeVector KGSurface::Point( const KThreeVector& aQueryPoint ) const
    {
        if( fArea )
        {
            ...
            tNearestPoint[ 0 ] = fOrigin[ 0 ] + tLocalNearestPoint[ 0 ] * fXAxis[ 0 ] + tLocalNearestPoint[ 1 ] * fYAxis[ 0 ] + tLocalNearestPoint[ 2 ] * fZAxis[ 0 ];
            tNearestPoint[ 1 ] = fOrigin[ 1 ] + tLocalNearestPoint[ 0 ] * fXAxis[ 1 ] + tLocalNearestPoint[ 1 ] * fYAxis[ 1 ] + tLocalNearestPoint[ 2 ] * fZAxis[ 1 ];
            tNearestPoint[ 2 ] = fOrigin[ 2 ] + tLocalNearestPoint[ 0 ] * fXAxis[ 2 ] + tLocalNearestPoint[ 1 ] * fYAxis[ 2 ] + tLocalNearestPoint[ 2 ] * fZAxis[ 2 ];
    ...
    KThreeVector KGSurface::Normal( const KThreeVector& aQueryPoint ) const
    {
        if( fArea )
        {
            ...
            tNearestNormal[ 0 ] = tLocalNearestNormal[ 0 ] * fXAxis[ 0 ] + tLocalNearestNormal[ 1 ] * fYAxis[ 0 ] + tLocalNearestNormal[ 2 ] * fZAxis[ 0 ];
            tNearestNormal[ 1 ] = tLocalNearestNormal[ 0 ] * fXAxis[ 1 ] + tLocalNearestNormal[ 1 ] * fYAxis[ 1 ] + tLocalNearestNormal[ 2 ] * fZAxis[ 1 ];
            tNearestNormal[ 2 ] = tLocalNearestNormal[ 0 ] * fXAxis[ 2 ] + tLocalNearestNormal[ 1 ] * fYAxis[ 2 ] + tLocalNearestNormal[ 2 ] * fZAxis[ 2 ];
