...
namespace KGeoBag
{
    ...
    private:
        ...
        void OpenPointsRotatedToShellMesh( const OpenPoints& aPoints, ShellMesh& aMesh , const double& aAngleStart, const double& aAngleStop);
        void ClosedPointsRotatedToShellMesh( const ClosedPoints& aPoints, ShellMesh& aMesh , const double& aAngleStart, const double& aAngleStop);
