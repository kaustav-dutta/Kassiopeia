    ...
    void KGVTKMeshPainter::PaintElements()
    {
        ...
        for( KGMeshElementCIt elementIt = fCurrentElements->begin(); elementIt != fCurrentElements->end(); ++elementIt )
        {
            ...
            if( KGMeshRectangle* tMeshRectangle = dynamic_cast< KGMeshRectangle* >( *elementIt ) )
            {
                ...
                KThreeVector tPoint1 = fCurrentOrigin + tMeshRectangle->GetP1().X() * fCurrentXAxis + tMeshRectangle->GetP1().Y() * fCurrentYAxis + tMeshRectangle->GetP1().Z() * fCurrentZAxis;
                KThreeVector tPoint2 = fCurrentOrigin + tMeshRectangle->GetP2().X() * fCurrentXAxis + tMeshRectangle->GetP2().Y() * fCurrentYAxis + tMeshRectangle->GetP2().Z() * fCurrentZAxis;
                KThreeVector tPoint3 = fCurrentOrigin + tMeshRectangle->GetP3().X() * fCurrentXAxis + tMeshRectangle->GetP3().Y() * fCurrentYAxis + tMeshRectangle->GetP3().Z() * fCurrentZAxis;
            ...
            {
                KThreeVector tPoint0 = fCurrentOrigin + tMeshTriangle->GetP0().X() * fCurrentXAxis + tMeshTriangle->GetP0().Y() * fCurrentYAxis + tMeshTriangle->GetP0().Z() * fCurrentZAxis;
                KThreeVector tPoint1 = fCurrentOrigin + tMeshTriangle->GetP1().X() * fCurrentXAxis + tMeshTriangle->GetP1().Y() * fCurrentYAxis + tMeshTriangle->GetP1().Z() * fCurrentZAxis;
                KThreeVector tPoint2 = fCurrentOrigin + tMeshTriangle->GetP2().X() * fCurrentXAxis + tMeshTriangle->GetP2().Y() * fCurrentYAxis + tMeshTriangle->GetP2().Z() * fCurrentZAxis;
