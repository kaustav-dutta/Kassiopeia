...
namespace KGeoBag
{
    ...
    void KGExtrudedCircleSpaceMesher::VisitExtrudedClosedPathSpace( KGExtrudedCircleSpace* aExtrudedCircleSpace )
    {
        ...
        ClosedPointsExtrudedToTubeMesh( tCirclePoints, aExtrudedCircleSpace->ZMin(), aExtrudedCircleSpace->ZMax(), aExtrudedCircleSpace->ExtrudedMeshCount(), aExtrudedCircleSpace->ExtrudedMeshPower(), tMeshPoints );

        //create start flattened mesh points
        TubeMesh tStartMeshPoints;
        KThreeVector tStartApex;
        ClosedPointsFlattenedToTubeMeshAndApex( tCirclePoints, aExtrudedCircleSpace->Path()->Centroid(), aExtrudedCircleSpace->ZMin(), aExtrudedCircleSpace->FlattenedMeshCount(), aExtrudedCircleSpace->FlattenedMeshPower(), tStartMeshPoints, tStartApex );

        //create end flattened mesh points
        TubeMesh tEndMeshPoints;
        KThreeVector tEndApex;
        ClosedPointsFlattenedToTubeMeshAndApex( tCirclePoints, aExtrudedCircleSpace->Path()->Centroid(), aExtrudedCircleSpace->ZMax(), aExtrudedCircleSpace->FlattenedMeshCount(), aExtrudedCircleSpace->FlattenedMeshPower(), tEndMeshPoints, tEndApex );
