...
namespace KGeoBag
{
    ...
    class KGSimpleAxialMesher :
        virtual public KGAxialMesherBase
    {
        public:
            KGSimpleAxialMesher();
        ...
        protected:
            void EndToOpenPoints( const KTwoVector& anEnd, const unsigned int& aMeshCount, const double& aMeshPower, OpenPoints& aPoints );
