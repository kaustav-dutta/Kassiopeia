...
namespace KGeoBag
{
  ...
  void KGDiscreteRotationalMesher::AddAxialMeshLoop(KGAxialMeshLoop* l)
  {
    ...
    if( fabs( (l->GetP0()[1]) - (l->GetP1()[1]) ) > 1.e-10 ) {
      ...
      KThreeVector P01( (l->GetP0()[1])*cos(2.*katrin::KConst::Pi()/fAxialCount), (l->GetP0()[1])*sin(2.*katrin::KConst::Pi()/fAxialCount), l->GetP0()[0] );

      KThreeVector P10( (l->GetP1()[1]), 0., l->GetP1()[0] );
      KThreeVector P11( (l->GetP1()[1])*cos(2.*katrin::KConst::Pi()/fAxialCount), (l->GetP1()[1])*sin(2.*katrin::KConst::Pi()/fAxialCount), l->GetP1()[0] );
    ...
    else
    {
    	...
    	KThreeVector P1( (l->GetP0()[1])*cos(2.*katrin::KConst::Pi()/fAxialCount), (l->GetP0()[1])*sin(2.*katrin::KConst::Pi()/fAxialCount), l->GetP0()[0] );
