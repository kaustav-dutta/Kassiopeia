...
namespace Binning{
  ...
  class BinningIteratorInterface{
  ...
  template <class DerivedIterator>
  bool operator==(const BinningIteratorInterface<DerivedIterator>& it1, const BinningIteratorInterface<DerivedIterator>& it2);
  template <class DerivedIterator>
  bool operator!=(const BinningIteratorInterface<DerivedIterator>& it1, const BinningIteratorInterface<DerivedIterator>& it2);
  ...
  template <class DerivedIterator>
  DerivedIterator& BinningIteratorInterface<DerivedIterator>::derivedIterator(){
  ...
  template <class DerivedIterator>
  auto& BinningIteratorInterface<DerivedIterator>::operator*(){
  ...
  template <class DerivedIterator>
  DerivedIterator& BinningIteratorInterface<DerivedIterator>::operator++(){
  ...
  template <class DerivedIterator>
  DerivedIterator BinningIteratorInterface<DerivedIterator>::operator++(int){
  ...
  template <class DerivedIterator>
  DerivedIterator& BinningIteratorInterface<DerivedIterator>::operator+=(std::ptrdiff_t n){
