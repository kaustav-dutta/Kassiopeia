...
namespace Binning{
  ...
  template <class DerivedIterator>
  auto& BinInterface<DerivedIterator>::derivedBin() const{
  ...
  template <class DerivedIterator>
  auto BinInterface<DerivedIterator>::lowerEdge() const{
  ...
  template <class DerivedIterator>
  auto BinInterface<DerivedIterator>::upperEdge() const{
  ...
  template <class DerivedIterator>
  auto BinInterface<DerivedIterator>::width() const{
  ...
  template <class DerivedIterator>
  auto BinInterface<DerivedIterator>::centre() const{
  ...
  template <class DerivedIterator>
  void BinInterface<DerivedIterator>::print(std::ostream& output) const{
