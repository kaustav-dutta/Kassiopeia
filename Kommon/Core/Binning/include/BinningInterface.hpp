...
namespace Binning{
  ...
  template <class DerivedBinning>
  const DerivedBinning& BinningInterface<DerivedBinning>::derivedBinning() const{
  ...
  template <class DerivedBinning>
  DerivedBinning& BinningInterface<DerivedBinning>::derivedBinning(){
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::numberOfBins() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::numberOfEdges() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::lowerEdge() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::upperEdge() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::lowerEdge(std::ptrdiff_t index) const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::upperEdge(std::ptrdiff_t index) const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::range() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::width(std::ptrdiff_t index) const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::centre(std::ptrdiff_t index) const{
  ...
  template <class DerivedBinning>
  bool BinningInterface<DerivedBinning>::valid() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::size() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::begin(){
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::end(){
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::begin() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::end() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::cbegin() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::cend() const{
  ...
  template <class DerivedBinning>
  bool BinningInterface<DerivedBinning>::empty() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::front() const{
  ...
  template <class DerivedBinning>
  auto BinningInterface<DerivedBinning>::back() const{
  ...
  template <class DerivedBinning>
  void BinningInterface<DerivedBinning>::print(std::ostream& output) const{
