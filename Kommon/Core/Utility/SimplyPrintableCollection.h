...
namespace katrin{
    ...
    namespace Kommon{
        ...
        struct SimplyPrintableCollection{
        ...
        template <class Derived>
        const Derived& SimplyPrintableCollection<Derived>::derived() const{
        ...
        std::ostream& operator<<(std::ostream& output, const SimplyPrintableCollection<Derived>& printableCollection){
            ...
            std::copy(std::begin(printableCollection.derived()), std::end(printableCollection.derived()), MakeOstreamJoiner(output, "\n"));
            return output;
