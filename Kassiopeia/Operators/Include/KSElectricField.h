...
namespace Kassiopeia
{
        ...
        public KSComponentTemplate< KSElectricField >
    {
        ...
        public:
            ...
            virtual void CalculateFieldAndPotential( const KThreeVector& aSamplePoint, const double& aSampleTime, KThreeVector& aField, double& aPotential )
            {
                CalculateField(aSamplePoint,aSampleTime,aField); CalculatePotential(aSamplePoint,aSampleTime,aPotential);
            };
    };
