...
namespace Kassiopeia
{
    ...
    void KESSSurfaceInteraction::ExecuteTransmission(const KSParticle& anInitialParticle,
    ...
    void KESSSurfaceInteraction::ExecuteReflection(const KSParticle& anInitialParticle,
                                                         KSParticle& aFinalParticle )
    {
        KThreeVector tNormal;
        KSSurface* tSurface = anInitialParticle.GetCurrentSurface();
    ...
    void KESSSurfaceInteraction::ExecuteInteraction( const KSParticle& anInitialParticle,
                                                           KSParticle& aFinalParticle,
                                                           KSParticleQueue& /*aQueue*/)
    {
        ...
        double tCosIncidentAngle = tNormal.Unit()
                                            .Dot(
                                                 anInitialParticle
                                                    .GetMomentum()
                                                        .Unit()
        ...
        double transmissionProbability = CalculateTransmissionProbability( tKineticEnergy,
                                                                           tCosIncidentAngle );
        ...
        {
            ExecuteTransmission( anInitialParticle,
                                       aFinalParticle );

        } else {

            ExecuteReflection( anInitialParticle,
                                     aFinalParticle );
        }
    }
