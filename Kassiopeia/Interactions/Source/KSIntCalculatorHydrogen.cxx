...
namespace Kassiopeia
{
    ...
    void KSIntCalculatorHydrogenElasticBase::CalculateCrossSection( const KSParticle& aParticle,
    ...
    void KSIntCalculatorHydrogenElasticBase::CalculateTheta( const double anEnergy,
                                                             double& aTheta
                                                           )
	{
    ...
    void KSIntCalculatorHydrogenElasticBase::CalculateDifferentialCrossSection( const double anEnergy,
    ...
    void KSIntCalculatorHydrogenElastic::CalculateCrossSection( const double anEnergie,
                                                                double& aCrossSection
                                                              )
    {
...
//        Trajmar, Phys Reports 97 (1983) 221.
    ...
    void KSIntCalculatorHydrogenElastic::CalculateEloss( const double anEnergie,
                                                         const double aTheta,
                                                         double& anEloss
                                                       )
	{
    ...
    void KSIntCalculatorHydrogenVib::CalculateCrossSection( const double anEnergie,
                                                            double& aCrossSection
                                                          )
    {
        unsigned int i;
            ...
            else
            {
                if( anEnergie >= 1.0 && anEnergie < 5.0 )
                {
                    ...
                    aCrossSection = 1.e-20
                                    * ( sigma2[ i ]
                                        + (sigma2[ i + 1 ] - sigma2[ i ])
                                           * (anEnergie - 1.0 - i * 0.5) * 2.
                                      );
                }
                else
                {
                    i = (anEnergie - 5.0) / 1.0;
                    aCrossSection = 1.e-20 * ( sigma3[ i ]
                                               + (sigma3[ i + 1 ] - sigma3[ i ])
                                                  * (anEnergie - 5.0 - i * 1.0)
                                             );
                }
    ...
    void KSIntCalculatorHydrogenVib::CalculateEloss( const double,
                                                     const double,
                                                     double& anEloss
                                                   )
	{
    ...
    void KSIntCalculatorHydrogenRot02::CalculateCrossSection( const double anEnergie,
                                                              double& aCrossSection
                                                            )
    {
        unsigned int i;
    ...
    void KSIntCalculatorHydrogenRot02::CalculateEloss( const double,
                                                       const double,
                                                       double& anEloss
                                                     )
	{
    ...
    void KSIntCalculatorHydrogenRot13::CalculateCrossSection( const double anEnergie,
                                                              double& aCrossSection
                                                            )
    {
        unsigned int i;
    ...
    void KSIntCalculatorHydrogenRot13::CalculateEloss( const double,
                                                       const double,
                                                       double& anEloss
                                                     )
	{
    ...
    void KSIntCalculatorHydrogenExcitationBase::CalculateCrossSection( const KSParticle& aParticle,
                                                                       double& aCrossSection
                                                                     )
    {
        CalculateCrossSection( aParticle.GetKineticEnergy_eV(), aCrossSection );
    ...
    void KSIntCalculatorHydrogenExcitationBase::CalculateTheta( const double anEnergy,
                                                                double& aTheta
                                                              )
	{        
    ...
    double KSIntCalculatorHydrogenExcitationBase::Lagrange( int n,
                                                            double *xn,
                                                            double *fn,
                                                            double x
                                                          )
    ...
    const double KSIntCalculatorHydrogenExcitationB
                    ::EnergyLevels[28] = {0.411, 0.417, 0.423, 0.428, 0.434, 0.439, 0.444,0.449,
    ...
    const double KSIntCalculatorHydrogenExcitationB
                    ::FrankCondonFactors[28] = {4.2e-3,1.5e-2,3.0e-2,4.7e-2,6.3e-2,7.3e-2,7.9e-2,
    ...
    const double KSIntCalculatorHydrogenExcitationB
                    ::CrossSectionParameters[9] = { -4.2935194e2, 5.1122109e2, -2.8481279e2,
                                                     8.8310338e1, -1.6659591e1, 1.9579609,
                                                    -1.4012824e-1, 5.5911348e-3, -9.5370103e-5 };

    const double KSIntCalculatorHydrogenExcitationB
                    ::FCFactorsElectronicExcitation[7] = {35.86, 40.05, 6.58, 2.26, 9.61, 4.08, 1.54};

    void KSIntCalculatorHydrogenExcitationB::CalculateCrossSection( const double anEnergy,
                                                                    double& aCrossSection
                                                                  )
    {
        //********
    ...
    void KSIntCalculatorHydrogenExcitationB::CalculateEloss( const double,
                                                             const double,
                                                             double& anEloss
                                                           )
	{
    ...
    //   (from: Phys. Rev. A51 (1995) 3745 , in Hartree atomic units)
    const double KSIntCalculatorHydrogenExcitationC
                    ::EnergyLevels[14] = {0.452,0.462,0.472,0.481,0.490,0.498,0.506,0.513,
                                     0.519,0.525,0.530,0.534,0.537,0.539};

    // Franck-Condon factors of the C vibrational states:
    //   (from: Phys. Rev. A51 (1995) 3745 )
    const double KSIntCalculatorHydrogenExcitationC
                    ::FrankCondonFactors[14] = {1.2e-1,1.9e-1,1.9e-1,1.5e-1,1.1e-1,7.5e-2,5.0e-2,
    ...
    const double KSIntCalculatorHydrogenExcitationC
                    ::CrossSectionParameters[9] = { -8.1942684e2, 9.8705099e2, -5.3095543e2,
    ...
    void KSIntCalculatorHydrogenExcitationC::CalculateCrossSection( const double anEnergy,
                                                                    double& aCrossSection
                                                                  )
    {
        //*********
    ...
    void KSIntCalculatorHydrogenExcitationC::CalculateEloss( const double,
                                                             const double,
                                                             double& anEloss
                                                           )
    {
    ...
    const double KSIntCalculatorHydrogenDissoziation10
                    ::CrossSectionParameters[9] = { -2.297914361e5, 5.303988579e5, -5.316636672e5,
                                                 3.022690779e5,-1.066224144e5,  2.389841369e4,
                                                -3.324526406e3, 2.624761592e2, -9.006246604  };

    void KSIntCalculatorHydrogenDissoziation10::CalculateCrossSection( const double anEnergy,
                                                                       double &aCrossSection
                                                                     )
    {
        double lnsigma,lnE,lnEn;
    ...
    void KSIntCalculatorHydrogenDissoziation10::CalculateEloss( const double /*anEnergy*/,
                                                                const double /*aTheta*/,
                                                                double &anEloss
                                                              )
    {
    ...
    const double KSIntCalculatorHydrogenDissoziation15
                    ::CrossSectionParameters[9] = { -1.157041752e3,  1.501936271e3,  -8.6119387e2,
                                                     2.754926257e2, -5.380465012e1,   6.573972423,
                                                    -4.912318139e-1, 2.054926773e-2, -3.689035889e-4 };


    void KSIntCalculatorHydrogenDissoziation15::CalculateCrossSection( const double anEnergy,
                                                                       double &aCrossSection
                                                                     )
    {
        double lnsigma,lnE,lnEn;
    ...
    void KSIntCalculatorHydrogenDissoziation15::CalculateEloss( const double /*anEnergy*/,
                                                                const double /*aTheta*/,
                                                                double &anEloss
                                                              )
    {
    ...
    const double KSIntCalculatorHydrogenExcitationElectronic
                    ::EnergyLevels[7] = {12.73, 13.2, 14.77, 15.3,14.93, 15.4, 13.06};

    // Probability numbers of the electronic states:
    //  (from testelectron7.c calculation )
    const double KSIntCalculatorHydrogenExcitationElectronic::
                    FrankCondonFactors[7] = {35.86, 40.05, 6.58, 2.26, 9.61, 4.08, 1.54};

    void KSIntCalculatorHydrogenExcitationElectronic::CalculateCrossSection( const double anEnergy,
                                                                            double &aCrossSection
                                                                          )
    {
        if( anEnergy < Emin )
    ...
    void KSIntCalculatorHydrogenExcitationElectronic::CalculateEloss( const double /*anEnergy*/,
                                                                     const double /*aTheta*/,
                                                                     double &anEloss
                                                                   )
    {
    ...
    KSIntCalculatorHydrogenIonisation::KSIntCalculatorHydrogenIonisation( const double aCrossParam_A1,
                                                                const double aCrossParam_A2,
                                                                const double aCrossParam_A3,
                                                                const double aCrossExponent,
                                                                const double abeta,
                                                                const double agamma,
                                                                const double aG_5,
                                                                const double ag_b,
                                                           ...
                                                           )
    {
        ...
        double sigma_max;
        CalculateEnergyDifferentialCrossSection( aReducedInitalEnergy,
                                                 aReducedInitalEnergy - 1.01,
                                                 sigma_max
                                               );

        double sigma_min;
        CalculateEnergyDifferentialCrossSection( aReducedInitalEnergy,
                                                 (aReducedInitalEnergy -1) /2,
                                                 sigma_min
                                               );

        while ( true )
        {            
            tReducedFinalEnergy = KRandom::GetInstance().Uniform( ( aReducedInitalEnergy - 1. ) / 2.,
                                                                  aReducedInitalEnergy - 1.,
                                                                  false, true
                                                                );
            ...
            double tRandom = KRandom::GetInstance()
                                .Uniform( 0.,
    ...
    void KSIntCalculatorHydrogenIonisation::CalculateCrossSection( const double anEnergy,
                                                              double &aCrossSection
                                                            )
    {
                                                                              ...
                                                                              )
    {
        ...
        aCrossSection = G_1( aReducedInitialEnergy, aReducedFinalEnergy ) *
                       ( g_BE( aReducedInitialEnergy, aReducedFinalEnergy )
                         + G_4( aReducedInitialEnergy, aReducedFinalEnergy ) * g_b
                       );
    }
    ...
    double KSIntCalculatorHydrogenIonisation::Formfactor( const double aReducedEnergy )
    {
        ...
        return ( CrossParam_A1 * log( aReducedEnergy )
                 + CrossParam_A2
                 + CrossParam_A3 / aReducedEnergy
               ) / aReducedEnergy;
    }
    ...
    double KSIntCalculatorHydrogenIonisation::g_1( const double aReducedEnergy )
    {
        ...
        return ( 1. - pow( aReducedEnergy, 1-CrossExponent ) ) / ( CrossExponent - 1. )
               - pow( 2. / (aReducedEnergy+1), CrossExponent / 2. )
                 * ( 1 - pow( aReducedEnergy, 1. - CrossExponent / 2. ) )
                 / ( CrossExponent - 2. );
    }

    double KSIntCalculatorHydrogenIonisation::g_BE( const double aReducedInitialEnergy,
                                               const double aReducedFinalEnergy
                                             )
    {
    ...
    double KSIntCalculatorHydrogenIonisation::f_1( const double aReducedInitialEnergy,
                                              const double aReducedFinalEnergy
                                            )
    {
        ...
        return   1./ ( pow( aReducedFinalEnergy + 1, CrossExponent ) )
               ...
               - 1./ (pow( ( aReducedFinalEnergy + 1 )
                           * ( aReducedInitialEnergy - aReducedFinalEnergy )
                           , CrossExponent / 2.
                         )
                     );
    }
    ...
    double KSIntCalculatorHydrogenIonisation::f_BE( const double aReducedInitialEnergy,
                                               const double aReducedFinalEnergy,
                                               const double aCosTheta
                                             )
    {
    ...
    double KSIntCalculatorHydrogenIonisation::G_1( const double aReducedInitialEnergy,
                                              const double aReducedFinalEnergy
                                            )
    {
        // G_1(t, w) = \frac{ S F(t) f_1(t, w)}{I( g_{BE}(t, w) + G_4(t, w)g_b)}

        return Normalisation * Formfactor( aReducedInitialEnergy )
               * f_1( aReducedInitialEnergy, aReducedFinalEnergy )
               / BindingEnergy
               / ( g_BE( aReducedInitialEnergy, aReducedFinalEnergy )
                   + G_4( aReducedInitialEnergy, aReducedFinalEnergy ) * g_b
                 );
    ...
    double KSIntCalculatorHydrogenIonisation::G_2( const double aReducedInitialEnergy,
                                              const double aReducedFinalEnergy
                                            )
    {
    ...
    double KSIntCalculatorHydrogenIonisation::G_3( const double aReducedInitialEnergy,
                                              const double aReducedFinalEnergy
                                            )
    {
        // G_3(t, w) = \beta\sqrt{\frac{1-G_2^2}{w}}

        return beta * sqrt( ( 1. - pow( G_2( aReducedInitialEnergy, aReducedFinalEnergy), 2 ) )
                            / aReducedFinalEnergy
                          );
    }

    double KSIntCalculatorHydrogenIonisation::G_4( const double aReducedInitialEnergy,
                                              const double aReducedFinalEnergy
                                            )
    {
