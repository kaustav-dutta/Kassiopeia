...
namespace Kassiopeia
{
    ...
    KSIntDecayCalculatorFerencBBRTransition::KSIntDecayCalculatorFerencBBRTransition( const KSIntDecayCalculatorFerencBBRTransition& aCopy ) :
            KSComponent(),
    ...
    void KSIntDecayCalculatorFerencBBRTransition::CalculateLifeTime( const KSParticle& aParticle,
                                                                   double& aLifeTime )
    {
        ...
        if ( (tPID == fTargetPID && fTargetPID != 0) || ( (tPID >= fminPID) && ( tPID <= fmaxPID)) )
        {
            ...
            fLastLifetime = 1./(fCalculator->PBBRdecay(fTemperature,n,l)
                            +fCalculator->PBBRexcitation(fTemperature,n,l,npmax));
            fLastn = n;
            fLastl = l;
