...
namespace Kassiopeia
{
    ...
    class KSTrajAdiabaticSpinError :
        public KSMathArray< 10 >
    {
        public:
            KSTrajAdiabaticSpinError();
            KSTrajAdiabaticSpinError( const KSTrajAdiabaticSpinError& other ) = default;
    ...
    template< class XLeft, class XOperation, class XRight >
    inline KSTrajAdiabaticSpinError& KSTrajAdiabaticSpinError::operator=( const KSMathExpression< XLeft, XOperation, XRight >& anOperand )
    {
        this->KSMathArray< 10 >::operator =( anOperand );
        return *this;
    }
