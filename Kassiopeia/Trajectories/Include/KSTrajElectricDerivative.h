...
namespace Kassiopeia
{
    ...
    class KSTrajElectricDerivative :
        public KSMathArray< 5 >
    {
        public:
            KSTrajElectricDerivative();
            KSTrajElectricDerivative( const KSTrajElectricDerivative& other) = default;
    ...
    template< class XLeft, class XOperation, class XRight >
    inline KSTrajElectricDerivative& KSTrajElectricDerivative::operator=( const KSMathExpression< XLeft, XOperation, XRight >& anOperand )
    {
        this->KSMathArray< 5 >::operator =( anOperand );
        return *this;
    }
