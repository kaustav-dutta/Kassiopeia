...
namespace Kassiopeia
{
    ...
    class KSTrajMagneticDerivative :
    ...
    template< class XLeft, class XOperation, class XRight >
    inline KSTrajMagneticDerivative& KSTrajMagneticDerivative::operator=( const KSMathExpression< XLeft, XOperation, XRight >& anOperand )
    {
        this->KSMathArray< 5 >::operator =( anOperand );
        return *this;
    }
