...
namespace Kassiopeia
{
    ...
    class KSTrajExactTrappedError :
        public KSMathArray< 8 >
    {
        public:
            KSTrajExactTrappedError();
            KSTrajExactTrappedError( const KSTrajExactTrappedError& other ) = default;
    ...
    template< class XLeft, class XOperation, class XRight >
    inline KSTrajExactTrappedError& KSTrajExactTrappedError::operator=( const KSMathExpression< XLeft, XOperation, XRight >& anOperand )
    {
        this->KSMathArray< 8 >::operator =( anOperand );
        return *this;
    }
