...
namespace Kassiopeia
{
        ...
        public KSTrajElectricControl
    {
        public:
            ...
            KSTrajControlLength* Clone() const override; ~KSTrajControlLength() override;

        public:
            void Calculate( const KSTrajExactParticle& aParticle, double& aValue ) override;
            void Check( const KSTrajExactParticle& anInitialParticle, const KSTrajExactParticle& aFinalParticle, const KSTrajExactError& anError, bool& aFlag ) override;
            ...
            void Check( const KSTrajAdiabaticParticle& anInitialParticle, const KSTrajAdiabaticParticle& aFinalParticle, const KSTrajAdiabaticError& anError, bool& aFlag ) override;

            void Calculate( const KSTrajExactTrappedParticle& aParticle, double& aValue ) override;
            void Check( const KSTrajExactTrappedParticle& anInitialParticle, const KSTrajExactTrappedParticle& aFinalParticle, const KSTrajExactTrappedError& anError, bool& aFlag ) override;

            void Calculate( const KSTrajMagneticParticle& aParticle, double& aValue ) override;
            void Check( const KSTrajMagneticParticle& anInitialParticle, const KSTrajMagneticParticle& aFinalParticle, const KSTrajMagneticError& anError, bool& aFlag ) override;

            void Calculate( const KSTrajElectricParticle& aParticle, double& aValue ) override;
            void Check( const KSTrajElectricParticle& anInitialParticle, const KSTrajElectricParticle& aFinalParticle, const KSTrajElectricError& anError, bool& aFlag ) override;
