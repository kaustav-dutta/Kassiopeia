...
namespace Kassiopeia
{
    ...
    class KSTrajAdiabaticSpinDerivative :
        public KSMathArray< 10 >
    {
        public:
            KSTrajAdiabaticSpinDerivative();
            KSTrajAdiabaticSpinDerivative( const KSTrajAdiabaticSpinDerivative& other) = default;
    ...
    template< class XLeft, class XOperation, class XRight >
    inline KSTrajAdiabaticSpinDerivative& KSTrajAdiabaticSpinDerivative::operator=( const KSMathExpression< XLeft, XOperation, XRight >& anOperand )
    {
        this->KSMathArray< 10 >::operator =( anOperand );
        return *this;
    }

    inline KSTrajAdiabaticSpinDerivative& KSTrajAdiabaticSpinDerivative::operator=( const KSTrajAdiabaticSpinDerivative& anOperand )
    {
        this->KSMathArray< 10 >::operator =( anOperand );
        return *this;
    }
