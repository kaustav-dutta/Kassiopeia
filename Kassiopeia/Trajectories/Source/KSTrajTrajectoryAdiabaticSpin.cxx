...
namespace Kassiopeia
{
    ...
    void KSTrajTrajectoryAdiabaticSpin::CalculateTrajectory( const KSParticle& anInitialParticle, KSParticle& aFinalParticle, KThreeVector& aCenter, double& aRadius, double& aTimeStep )
    {
    ...
    void KSTrajTrajectoryAdiabaticSpin::GetPiecewiseLinearApproximation(const KSParticle& anInitialParticle, const KSParticle& /*aFinalParticle*/, std::vector< KSParticle >* intermediateParticleStates) const
    {
    ...
    STATICINT sKSTrajTrajectoryAdiabaticSpinDict =
        KSDictionary< KSTrajTrajectoryAdiabaticSpin >::AddCommand( &KSTrajTrajectoryAdiabaticSpin::SetIntegrator, &KSTrajTrajectoryAdiabaticSpin::ClearIntegrator, "set_integrator", "clear_integrator" ) +
        KSDictionary< KSTrajTrajectoryAdiabaticSpin >::AddCommand( &KSTrajTrajectoryAdiabaticSpin::SetInterpolator, &KSTrajTrajectoryAdiabaticSpin::ClearInterpolator, "set_interpolator", "clear_interpolator" ) +
        KSDictionary< KSTrajTrajectoryAdiabaticSpin >::AddCommand( &KSTrajTrajectoryAdiabaticSpin::AddTerm, &KSTrajTrajectoryAdiabaticSpin::RemoveTerm, "add_term", "remove_term" ) +
        KSDictionary< KSTrajTrajectoryAdiabaticSpin >::AddCommand( &KSTrajTrajectoryAdiabaticSpin::AddControl, &KSTrajTrajectoryAdiabaticSpin::RemoveControl, "add_control", "remove_control" );
