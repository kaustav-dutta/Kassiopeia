...
namespace Kassiopeia
{
    ...
    void KSTrajTermDrift::Differentiate(double /*aTime*/, const KSTrajAdiabaticParticle& aParticle, KSTrajAdiabaticDerivative& aDerivative ) const
    {
        ...
        tMagneticGradientUnit.X() = tMagneticFieldUnit.X() * tMagneticGradient( 0, 0 ) + tMagneticFieldUnit.Y() * tMagneticGradient( 0, 1 ) + tMagneticFieldUnit.Z() * tMagneticGradient( 0, 2 );
        tMagneticGradientUnit.Y() = tMagneticFieldUnit.X() * tMagneticGradient( 1, 0 ) + tMagneticFieldUnit.Y() * tMagneticGradient( 1, 1 ) + tMagneticFieldUnit.Z() * tMagneticGradient( 1, 2 );
        tMagneticGradientUnit.Z() = tMagneticFieldUnit.X() * tMagneticGradient( 2, 0 ) + tMagneticFieldUnit.Y() * tMagneticGradient( 2, 1 ) + tMagneticFieldUnit.Z() * tMagneticGradient( 2, 2 );
