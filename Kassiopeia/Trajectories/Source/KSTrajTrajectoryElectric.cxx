...
namespace Kassiopeia
{
    ...
    void KSTrajTrajectoryElectric::CalculateTrajectory( const KSParticle& anInitialParticle, KSParticle& aFinalParticle, KThreeVector& aCenter, double& aRadius, double& aTimeStep )
    {
    ...
    void KSTrajTrajectoryElectric::GetPiecewiseLinearApproximation(const KSParticle& anInitialParticle, const KSParticle& /*aFinalParticle*/, std::vector< KSParticle >* intermediateParticleStates) const
    {
    ...
    STATICINT sKSTrajTrajectoryElectricDict =
        KSDictionary< KSTrajTrajectoryElectric >::AddCommand( &KSTrajTrajectoryElectric::SetIntegrator, &KSTrajTrajectoryElectric::ClearIntegrator, "set_integrator", "clear_integrator" ) +
        KSDictionary< KSTrajTrajectoryElectric >::AddCommand( &KSTrajTrajectoryElectric::SetInterpolator, &KSTrajTrajectoryElectric::ClearInterpolator, "set_interpolator", "clear_interpolator" ) +
        KSDictionary< KSTrajTrajectoryElectric >::AddCommand( &KSTrajTrajectoryElectric::AddTerm, &KSTrajTrajectoryElectric::RemoveTerm, "add_term", "remove_term" ) +
        KSDictionary< KSTrajTrajectoryElectric >::AddCommand( &KSTrajTrajectoryElectric::AddControl, &KSTrajTrajectoryElectric::RemoveControl, "add_control", "remove_control" );
