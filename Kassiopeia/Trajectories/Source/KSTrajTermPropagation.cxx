...
namespace Kassiopeia
{
    ...
    void KSTrajTermPropagation::Differentiate(double /*aTime*/, const KSTrajAdiabaticSpinParticle& aParticle, KSTrajAdiabaticSpinDerivative& aDerivative ) const
    {
        ...
        KThreeVector GradBMagnitude = aParticle.GetMagneticField() * aParticle.GetMagneticGradient() / aParticle.GetMagneticField().Magnitude();
        KThreeMatrix GradBDirection = aParticle.GetMagneticGradient() / aParticle.GetMagneticField().Magnitude()
                - KThreeMatrix::OuterProduct( aParticle.GetMagneticField(), GradBMagnitude ) / aParticle.GetMagneticField().Magnitude()
                / aParticle.GetMagneticField().Magnitude();
        KThreeMatrix GradE1 ( GradBDirection[ 6 ] , 0. , -GradBDirection[ 0 ] ,
                              GradBDirection[ 7 ] , 0. , -GradBDirection[ 1 ] ,
                              GradBDirection[ 8 ] , 0. , -GradBDirection[ 2 ] );
