...
namespace katrin
{
    ...
    template< >
    inline bool KSIntCalculatorArgonSetBuilder::AddAttribute( KContainer* aContainer )
    {
    ...
    template< >
    inline bool KSIntCalculatorArgonSetBuilder::End()
    {
