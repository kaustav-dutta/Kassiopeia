...
namespace Kassiopeia
{
    ...
    void KSRootSurfaceInteraction::ClearSurfaceInteraction( KSSurfaceInteraction* aSurfaceInteraction )
    {
        ...
        {
            intmsg( eError ) << "<" << GetName() << "> tried to remove surface interaction <" << aSurfaceInteraction->GetName() << "> with surface interaction <" << fSurfaceInteraction->GetName() << "> already set" << eom;
            return;
        }
    ...
    void KSRootSurfaceInteraction::ExecuteInteraction()
    {
        ...
        fStep->DiscreteEnergyChange() = fInteractionParticle->GetKineticEnergy_eV() - fTerminatorParticle->GetKineticEnergy_eV();
        fStep->DiscreteMomentumChange() = (fInteractionParticle->GetMomentum() - fTerminatorParticle->GetMomentum()).Magnitude();
