...
namespace Kassiopeia
{
    ...
    KSRootRunModifier::KSRootRunModifier(const KSRootRunModifier &aCopy) : KSComponent(),
    ...
    STATICINT sKSRootModifierDict =
            KSDictionary< KSRootRunModifier >::AddCommand( &KSRootRunModifier::AddModifier,
                                                            &KSRootRunModifier::RemoveModifier,
                                                            "add_modifier",
                                                            "remove_modifier" );
