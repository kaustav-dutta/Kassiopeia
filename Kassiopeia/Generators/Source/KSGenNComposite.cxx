...
namespace Kassiopeia
{
    ...
    void KSGenNComposite::SetNValue( KSGenValue* anNValue )
    {
        ...
        genmsg( eError ) << "cannot set n value <" << anNValue->GetName() << "> to composite n creator <" << this->GetName() << ">" << eom;
        return;
    }
    ...
    STATICINT sKSGenNCompositeDict =
        KSDictionary< KSGenNComposite >::AddCommand( &KSGenNComposite::SetNValue, &KSGenNComposite::ClearNValue, "set_n", "clear_n" );
