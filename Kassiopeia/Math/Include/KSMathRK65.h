...
namespace Kassiopeia
{
        ...
        public KSMathIntegrator< XSystemType >
    {
        ...
        public:
            ...
            bool GetFinalDerivative(DerivativeType& derv) const override
            {
                if(fHaveCachedDerivative)
                {
                    derv = fDerivatives[KSMATHRK65_STAGE]; return true;
                }
                return false;
            };
    ...
    template< class XSystemType >
    void KSMathRK65< XSystemType >::Integrate(double aTime, const DifferentiatorType& aTerm, const ValueType& anInitialValue, const double& aStep, ValueType& aFinalValue, ErrorType& anError ) const
    {
    ...
    template< class XSystemType >
    const double KSMathRK65< XSystemType >::fC[ KSMATHRK65_STAGE ] =
    {0., 1./10., 2./9., 3./7., 3./5., 4./5., 1., 1.};
    ...
    template< class XSystemType >
    const unsigned int KSMathRK65< XSystemType >::fAColumnLimit[KSMATHRK65_STAGE] =
    {0, 1, 2, 3, 4, 5, 6, 6};
