...
namespace Kassiopeia
{
        ...
        public KSMathIntegrator< XSystemType >
    {
        ...
        public:
            ...
            bool GetFinalDerivative(DerivativeType& derv) const override
            {
                if(fHaveCachedDerivative)
                {
                    derv = fDerivatives[KSMATHRK87_STAGE]; return true;
                }
                return false;
            };
            ...
            bool HasDenseOutput() const override {return false;};
    ...
    template< class XSystemType >
    void KSMathRK87< XSystemType >::Integrate(double aTime, const DifferentiatorType& aTerm, const ValueType& anInitialValue, const double& aStep, ValueType& aFinalValue, ErrorType& anError ) const
    {
    ...
    const double KSMathRK87< XSystemType >::fA[ KSMATHRK87_STAGE  ][ KSMATHRK87_STAGE ] =
    {
       ...
       {29443841./614563906., 0., 0., 77736538./692538347., -28693883./1125000000., 23124283./1800000000., 0., 0., 0., 0., 0., 0., 0.}, //7th row
       {16016141./946692911., 0., 0., 61564180./158732637., 22789713./633445777., 545815736./2771057229., -180193667./1043307555., 0., 0., 0., 0., 0., 0.}, //8th row
       {39632708./573591083., 0., 0., -433636366./683701615., -421739975./2616292301., 100302831./723423059., 790204164./839813087., 800635310./3783071287., 0., 0., 0., 0., 0.}, //9th row
       {246121993./1340847787., 0., 0., -37695042795./15268766246., -309121744./1061227803., -12992083./490766935., 6005943493./2108947869., 393006217./1396673457., 123872331./1001029789., 0.,  0., 0., 0.}, //10th row
       {-1028468189./846180014., 0., 0., 8478235783./508512852., 1311729495./1432422823., -10304129995./1701304382., -48777925059./3047939560., 15336726248./1032824649., -45442868181./3398467696., 3065993473./597172653., 0., 0., 0.}, //11th row
       {185892177./718116043., 0., 0., -3185094517./667107341., -477755414./1098053517., -703635378./230739211., 5731566787./1027545527., 5232866602./850066563., -4093664535./808688257., 3962137247./1805957418., 65686358./487910083., 0., 0.}, //12th row
       {403863854./491063109., 0., 0., -5068492393./434740067., -411421997./543043805., 652783627./914296604., 11173962825./925320556., -13158990841./6184727034., 3936647629./1978049680., -160528059./685178525., 248638103./1413531060., 0., 0.} //13th row
    };

    template< class XSystemType >
    const double KSMathRK87< XSystemType >::fB7[ KSMATHRK87_STAGE ] =
    ...
    template< class XSystemType >
    const double KSMathRK87< XSystemType >::fB8[ KSMATHRK87_STAGE ] =
    ...
    template< class XSystemType >
    const double KSMathRK87< XSystemType >::fC[ KSMATHRK87_STAGE ] =
    {0.0, 1.0/18.0, 1.0/12., 1.0/8.0, 5.0/16.0, 3.0/8.0, 59.0/400.0, 93.0/200., 5490023248./9719169821., 13./20., 1201146811./1299019798., 1., 1.};
