...
namespace Kassiopeia
{
    ...
    class KSList
    {
        public:
            ...
            void ForEach( XReturnType (XClassType::*aMember)() );
            template< class XReturnType, class XClassType >
            void ForEach( XReturnType (XClassType::*aMember)() const );
            ...
            void ForEach( XReturnType (XClassType::*aMember)( XArgumentType1, XArgumentType2 ), XArgumentType1 anArgument1, XArgumentType2 anArgument2 );
            template< class XReturnType, class XClassType, class XArgumentType1, class XArgumentType2 >
            void ForEach( XReturnType (XClassType::*aMember)( XArgumentType1, XArgumentType2 ) const, XArgumentType1 anArgument1, XArgumentType2 anArgument2 );

            template< class XClassType >
            bool ForEachUntilTrue( bool (XClassType::*aMember)() );
            template< class XClassType >
            bool ForEachUntilTrue( bool (XClassType::*aMember)() const );
            ...
            bool ForEachUntilTrue( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ), XArgumentType1 anArgument1, XArgumentType2 anArgument2 );
            template< class XClassType, class XArgumentType1, class XArgumentType2 >
            bool ForEachUntilTrue( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ) const, XArgumentType1 anArgument1, XArgumentType2 anArgument2 );

            template< class XClassType >
            bool ForEachUntilFalse( bool (XClassType::*aMember)() );
            template< class XClassType >
            bool ForEachUntilFalse( bool (XClassType::*aMember)() const );
            template< class XClassType, class XArgumentType >
            ...
            template< class XClassType, class XArgumentType1, class XArgumentType2 >
            bool ForEachUntilFalse( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ), XArgumentType1 anArgument1, XArgumentType2 anArgument2 );
            template< class XClassType, class XArgumentType1, class XArgumentType2 >
            bool ForEachUntilFalse( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ) const, XArgumentType1 anArgument1, XArgumentType2 anArgument2 );

            template< class XClassType, class XReturnType >
            XReturnType LargestOfAll( XReturnType (XClassType::*aMember)() );

            template< class XClassType, class XReturnType >
            XReturnType SmallestOfAll( XReturnType (XClassType::*aMember)() );

            template< class XClassType, class XReturnType >
            XReturnType SumOfAll( XReturnType (XClassType::*aMember)() );
    ...
    template< class XType >
    KSList< XType >::KSList( const int aMaxSize ) :
            fCurrentElement( 0 ),
            fEndElement( 0 ),
            fLastElement( aMaxSize )
    {
    ...
    template< class XType >
    KSList< XType >::KSList( const KSList& aCopy ) :
            fCurrentElement( 0 ),
            fEndElement( 0 ),
            fLastElement( aCopy.fLastElement )
    {
        fElements = new XType*[ fLastElement ];
        for( fCurrentElement = 0; fCurrentElement < fLastElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    int KSList< XType >::End() const
    {
        return fEndElement;
    }
    template< class XType >
    bool KSList< XType >::Full() const
    {
        return (fEndElement == fLastElement);
    }

    template< class XType >
    void KSList< XType >::ClearContent()
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
            if( fElements[ fCurrentElement ] != NULL )
            {
    ...
    template< class XType >
    void KSList< XType >::DeleteContent()
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
            if( fElements[ fCurrentElement ] != NULL )
    ...
    template< class XType >
    int KSList< XType >::AddElement( XType* anElement )
    {
    ...
    template< class XType >
    int KSList< XType >::FindElement( XType* anElement )
    {
        int tIndex = -1;
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    int KSList< XType >::RemoveElement( XType* anElement )
    {
        int tIndex = -1;
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    XType* KSList< XType >::ElementAt( int& anIndex ) const
    {
    ...
    template< class XType >
    template< class XReturnType, class XClassType, class XArgumentType1, class XArgumentType2 >
    void KSList< XType >::ForEach( XReturnType (XClassType::*aMember)( XArgumentType1, XArgumentType2 ), XArgumentType1 anArgument1, XArgumentType2 anArgument2 )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    template< class XReturnType, class XClassType, class XArgumentType1, class XArgumentType2 >
    void KSList< XType >::ForEach( XReturnType (XClassType::*aMember)( XArgumentType1, XArgumentType2 ) const, XArgumentType1 anArgument1, XArgumentType2 anArgument2 )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
            (fElements[ fCurrentElement ]->*aMember)( anArgument1, anArgument2 );
    ...
    template< class XType >
    template< class XClassType >
    bool KSList< XType >::ForEachUntilTrue( bool (XClassType::*aMember)() )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    template< class XClassType, class XArgumentType1, class XArgumentType2 >
    bool KSList< XType >::ForEachUntilTrue( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ), XArgumentType1 anArgument1, XArgumentType2 anArgument2 )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    template< class XClassType, class XArgumentType1, class XArgumentType2 >
    bool KSList< XType >::ForEachUntilTrue( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ) const, XArgumentType1 anArgument1, XArgumentType2 anArgument2 )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
            if( (fElements[ fCurrentElement ]->*aMember)( anArgument1, anArgument2 ) == true )
    ...
    template< class XType >
    template< class XClassType >
    bool KSList< XType >::ForEachUntilFalse( bool (XClassType::*aMember)() )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    template< class XClassType, class XArgumentType1, class XArgumentType2 >
    bool KSList< XType >::ForEachUntilFalse( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ), XArgumentType1 anArgument1, XArgumentType2 anArgument2 )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
    ...
    template< class XType >
    template< class XClassType, class XArgumentType1, class XArgumentType2 >
    bool KSList< XType >::ForEachUntilFalse( bool (XClassType::*aMember)( XArgumentType1, XArgumentType2 ) const, XArgumentType1 anArgument1, XArgumentType2 anArgument2 )
    {
        for( fCurrentElement = 0; fCurrentElement < fEndElement; fCurrentElement++ )
        {
            if( (fElements[ fCurrentElement ]->*aMember)( anArgument1, anArgument2 ) == false )
