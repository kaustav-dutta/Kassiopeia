...
namespace KEMField
{
  ...
  public:
    ...
    const KPosition   GetP2()                 const { return fP0 + fN2*fB; }
    ...
    void              GetP2(KPosition& p2)    const { p2 = fP0 + fN2*fB; }
  ...
  Stream& operator>>(Stream& s,KTriangle& t)
  {
  ...
  template <typename Stream>
  Stream& operator<<(Stream& s,const KTriangle& t)
  {
