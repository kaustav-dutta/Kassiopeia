...
namespace KEMField
{
  void KRectangle::SetValues(const double& a,
			     const double& b,
			     const KPosition& p0,
			     const KDirection& n1,
			     const KDirection& n2)
  ...
  void KRectangle::SetValues(const KPosition& p0,
			     const KPosition& p1,
			     const KPosition& /*p2*/,
			     const KPosition& p3)
  {
   ...
   */
  double KRectangle::DistanceTo(const KPosition& aPoint,
				  KPosition& nearestPoint)
  {
