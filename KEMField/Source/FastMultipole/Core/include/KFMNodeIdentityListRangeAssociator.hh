...
class KFMNodeIdentityListRangeAssociator: public KFMNodeActor< KFMNode<ObjectTypeList> >
{
    public:
        ...
        const std::vector<unsigned int>* GetNodeStartIndexList() const {return &fNodeStartIndexList; };
        void GetNodeStartIndexList(std::vector<unsigned int>* list) const {*list = fNodeStartIndexList;};

        const std::vector<unsigned int>* GetNodeIndexListSize() const {return &fNodeIndexListSize; };
        void GetNodeIndexListSize(std::vector<unsigned int>* list) const {*list = fNodeIndexListSize;};
