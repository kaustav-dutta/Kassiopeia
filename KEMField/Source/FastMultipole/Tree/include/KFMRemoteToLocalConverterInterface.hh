...
class KFMRemoteToLocalConverterInterface: public KFMNodeActor< KFMNode<ObjectTypeList> >
{
    public:
        ...
        M2LType* GetTopLevelM2LConverter(){return fTopLevelM2LConverter;};
        M2LType* GetTreeM2LConverter(){return fM2LConverter;};

        bool IsScaleInvariant() const {return fM2LConverter->IsScaleInvariant();};
