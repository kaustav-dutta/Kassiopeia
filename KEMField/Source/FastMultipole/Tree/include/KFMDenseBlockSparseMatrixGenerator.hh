...
class KFMDenseBlockSparseMatrixGenerator: public KFMNodeActor< KFMNode<ObjectTypeList> >
{
    public:
        ...
        void SetVerbosity(unsigned int v){fVerbose = v;};
        ...
        void Finalize()
        {
            if(!fMatrixOnFile)
            {
                ...
                KSAObjectOutputNode< KFMDenseBlockSparseMatrixStructure >* structure_node = new KSAObjectOutputNode<KFMDenseBlockSparseMatrixStructure>( KSAClassName<KFMDenseBlockSparseMatrixStructure>::name() );
