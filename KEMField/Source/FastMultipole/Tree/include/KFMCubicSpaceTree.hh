...
class KFMCubicSpaceTree: public KFMTree<ObjectTypeList>
{
    public:
        ...
        KFMCubicSpaceTreeProperties<NDIM>* GetTreeProperties(){return fTreeProperties;};
        ...
        KFMCubicSpaceNodeProgenitor<NDIM,ObjectTypeList>* GetProgenitor(){return fProgenitor;};
