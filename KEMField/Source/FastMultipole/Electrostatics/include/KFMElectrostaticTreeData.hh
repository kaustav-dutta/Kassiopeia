...
class KFMElectrostaticTreeData: public KSAInputOutputObject
{
    public:
        ...
        const std::vector<KFMNodeData>* GetFlattenedTreePointer() const {return &fFlattenedTree;};
        std::vector<KFMNodeData>* GetFlattenedTreePointer() {return &fFlattenedTree;};
        ...
        const std::vector<int>* GetLocalCoefficientNodeIDPointer() const {return &fLocalCoefficientsNodeIDs;};
        std::vector<int>* GetLocalCoefficientNodeIDPointer() {return &fLocalCoefficientsNodeIDs;};
        ...
        const std::vector< KFMElectrostaticLocalCoefficientSet* >* GetLocalCoefficientPointer() const {return &fLocalCoefficients;};
        std::vector< KFMElectrostaticLocalCoefficientSet* >* GetLocalCoefficientPointer() {return &fLocalCoefficients;};
        ...
        const std::vector< KFMIdentitySet* >* GetIdentitySetPointer() const {return &fIdentitySets;};
        std::vector< KFMIdentitySet* >* GetIdentitySetPointer() {return &fIdentitySets;};
        ...
        const std::vector< KFMCube<3>* >* GetCubePointer() const {return &fCubes;};
        std::vector< KFMCube<3>* >* GetCubePointer() {return &fCubes;};
        ...
        unsigned int GetDegree() const {return fDegree;};
        void SetDegree(const unsigned int& deg){fDegree = deg;};

        unsigned int GetZeroMaskSize() const {return fZeroMaskSize;};
        void SetZeroMaskSize(const unsigned int& zm){fZeroMaskSize = zm;};
...
Stream& operator>>(Stream& s, KFMElectrostaticTreeData& aData)
{
...
template <typename Stream>
Stream& operator<<(Stream& s,const KFMElectrostaticTreeData& aData)
{
