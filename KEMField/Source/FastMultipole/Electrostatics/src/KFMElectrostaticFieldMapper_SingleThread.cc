...
void
KFMElectrostaticFieldMapper_SingleThread::SetTree(KFMElectrostaticTree* tree)
{
    fTree = tree;
...
//set parameters
void
KFMElectrostaticFieldMapper_SingleThread::SetParameters(KFMElectrostaticParameters params)
{
    ...
    if(fVerbosity > 2)
    {
        ...
        kfmout<<"KFMElectrostaticFieldMapper_SingleThread::SetParameters: max tree depth set to "<<params.maximum_tree_depth<<kfmendl;
    }
}


void
KFMElectrostaticFieldMapper_SingleThread::Initialize()
{

    if(fVerbosity > 2)
    {
        kfmout<<"KFMElectrostaticFieldMapper_SingleThread::Initialize: Initializing the element multipole moment batch calculator. ";
    }
    ...
    if(fVerbosity > 2)
    {
        kfmout<<"KFMElectrostaticFieldMapper_SingleThread::Initialize: Initializing the multipole to multipole translator. ";
    }
...
void
KFMElectrostaticFieldMapper_SingleThread::MapField()
{
...
void
KFMElectrostaticFieldMapper_SingleThread::AssociateElementsAndNodes()
{
    ...
    if(fVerbosity > 2)
    {
        kfmout<<"KFMElectrostaticFieldMapper_SingleThread::AssociateElementsAndNodes: Done making element to node association. "<<kfmendl;
    }
}

void
KFMElectrostaticFieldMapper_SingleThread::InitializeMultipoleMoments()
{
...
void
KFMElectrostaticFieldMapper_SingleThread::ComputeMultipoleMoments()
{
...
void
KFMElectrostaticFieldMapper_SingleThread::InitializeLocalCoefficients() //full initialization for all nodes
{
...
void
KFMElectrostaticFieldMapper_SingleThread::CleanUp()
{
