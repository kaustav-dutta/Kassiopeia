...
template<typename ParallelTrait = KFMElectrostaticFieldMapper_SingleThread>
class KFMElectrostaticTreeConstructor
{
    public:
        ...
        void ConstructTree(const KSurfaceContainer& surface_container, KFMElectrostaticTree& tree) const
        {
            ...
            {
                kfmout<<"KFMElectrostaticTreeConstructor::ConstructTree: Constructing fast multipole region tree from surface container."<<kfmendl;
            }
...
////////////////////////////////////////////////////////////////////////////////
        ...
        void ConstructTree(const KSortedSurfaceContainer& surface_container, KFMElectrostaticTree& tree) const
        {
            ...
            if(params.verbosity > 0)
            {
                kfmout<<"KFMElectrostaticTreeConstructor::ConstructTree: Constructing fast multipole region tree from sorted surface container."<<kfmendl;
            }
...
////////////////////////////////////////////////////////////////////////////////
        ...
        void ConstructTree(KFMElectrostaticTreeData& data, KFMElectrostaticTree& tree) const
        {
            ...
            for(unsigned int i=0; i<n_nodes; i++)
            {
                ...
                KFMObjectRetriever<KFMElectrostaticNodeObjects, KFMCubicSpaceTreeProperties<3> >::SetNodeObject(tree_prop, tree_nodes[i]);
            }
            ...
            for(unsigned int i=0; i<local_coeff_node_ids.size(); i++)
            {
                ...
                KFMObjectRetriever<KFMElectrostaticNodeObjects, KFMElectrostaticLocalCoefficientSet>::SetNodeObject(local_coeff[i], node);
            }
