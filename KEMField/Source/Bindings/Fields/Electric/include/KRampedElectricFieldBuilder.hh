...
typedef KComplexElement<KEMField::KRampedElectricField>
KRampedElectricFieldBuilder;

template< >
inline bool KRampedElectricFieldBuilder::AddAttribute( KContainer* aContainer )
{
