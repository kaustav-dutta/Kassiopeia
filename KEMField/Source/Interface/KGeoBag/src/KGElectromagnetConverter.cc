...
namespace KGeoBag
{
    ...
    void KGElectromagnetConverter::SetSystem( const KThreeVector& anOrigin, const KThreeVector& anXAxis, const KThreeVector& aYAxis, const KThreeVector& aZAxis )
    {
        fOrigin = anOrigin;
        fXAxis = anXAxis;
        fYAxis = aYAxis;
    ...
    {
        KThreeMatrix tTransform(fXAxis[0],fYAxis[0],fZAxis[0],
        ...
        KThreeMatrix tThreeMatrix(tTransform[0],tTransform[1],tTransform[2],
                tTransform[3],tTransform[4],tTransform[5],
                tTransform[6],tTransform[7],tTransform[8]);
        return tThreeMatrix;
    }
