...
int main(int argc, char* argv[])
{
    ...
    for( unsigned int i=0; i<potDiffContainer.size(); i++ ) {
        if( potDiffContainer[i] < minPot ) minPot = potDiffContainer[i];
        if( potDiffContainer[i] > maxPot ) maxPot = potDiffContainer[i];
        if( fieldDiffContainer[i] < minField ) minField = fieldDiffContainer[i];
        if( fieldDiffContainer[i] > maxField ) maxField = fieldDiffContainer[i];
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////
    KEMField::cout << "(3) Random points on circle surface (xy) at z=0 with r=4.67 (r=4.672m -> caps)" << KEMField::endl;
    ////////////////////////////////////////////////////////////////////////////////////
