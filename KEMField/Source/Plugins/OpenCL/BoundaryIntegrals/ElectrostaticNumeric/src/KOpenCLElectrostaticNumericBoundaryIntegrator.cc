...
namespace KEMField
{
  KOpenCLElectrostaticNumericBoundaryIntegrator::KOpenCLElectrostaticNumericBoundaryIntegrator(KOpenCLSurfaceContainer& c) :
    KOpenCLBoundaryIntegrator<KElectrostaticBasis>(c),
	fPhiKernel(NULL), fEFieldKernel(NULL), fEFieldAndPhiKernel(NULL), fBufferPhi(NULL), fBufferEField(NULL), fBufferEFieldAndPhi(NULL)
  {
  ...
  KElectrostaticBasis::ValueType KOpenCLElectrostaticNumericBoundaryIntegrator::BoundaryIntegral(KSurfacePrimitive* source,KSurfacePrimitive* target,unsigned int)
  {
    fTarget = target;
  ...
  KElectrostaticBasis::ValueType KOpenCLElectrostaticNumericBoundaryIntegrator::BoundaryValue(KSurfacePrimitive* surface,unsigned int)
  {
    surface->Accept(fBoundaryVisitor);
    return fBoundaryVisitor.GetBoundaryValue();
  }

  KElectrostaticBasis::ValueType& KOpenCLElectrostaticNumericBoundaryIntegrator::BasisValue(KSurfacePrimitive* surface,unsigned int)
  {
  ...
  void KOpenCLElectrostaticNumericBoundaryIntegrator::ConstructOpenCLKernels() const
  {
    ...
    clFile << KOpenCLInterface::GetInstance()->GetKernelPath() << "/kEMField_ElectrostaticNumericBoundaryIntegrals_kernel.cl";
