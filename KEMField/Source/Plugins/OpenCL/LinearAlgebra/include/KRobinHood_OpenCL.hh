...
namespace KEMField
{
  ...
  class KRobinHood_OpenCL : public KOpenCLAction
  {
  public:
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::ConstructOpenCLKernels() const
  {
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::AssignBuffers() const
  {
  ...
  template <typename ValueType>
  KRobinHood_OpenCL<ValueType>::~KRobinHood_OpenCL()
  {
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::Initialize()
  {
    if (!fReadResidual)
    {
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::FindResidual()
  {
    try
    {
    KOpenCLInterface::GetInstance()->
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::FindResidualNorm(double& residualNorm)
  {
    KOpenCLInterface::GetInstance()->
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::CompleteResidualNormalization(double& residualNorm)
  {
    KOpenCLInterface::GetInstance()->
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::IdentifyLargestResidualElement()
  {
    try
    {
    KOpenCLInterface::GetInstance()->
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::ComputeCorrection()
  {
    KOpenCLInterface::GetInstance()->
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::UpdateSolutionApproximation()
  {
    KOpenCLInterface::GetInstance()->
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::UpdateVectorApproximation()
  {
    KOpenCLInterface::GetInstance()->
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::CoalesceData()
  {
    dynamic_cast<KOpenCLSurfaceContainer&>(fData).ReadBasisData();
  }

  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::Finalize()
  {
    dynamic_cast<KOpenCLSurfaceContainer&>(fData).ReadBasisData();
  }

  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::SetResidualVector(const Vector& v)
  {
    fReadResidual = true;
  ...
  template <typename ValueType>
  void KRobinHood_OpenCL<ValueType>::GetResidualVector(Vector& v) const
  {
    cl::Event event;
    KOpenCLInterface::GetInstance()->GetQueue().
