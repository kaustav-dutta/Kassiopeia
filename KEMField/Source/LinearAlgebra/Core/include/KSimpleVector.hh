...
namespace KEMField
{
  ...
  public:
    ...
    const ValueType& operator()(unsigned int i) const override { return fElements[i]; }
    ValueType& operator[](unsigned int i) override { return fElements[i]; }

    unsigned int Dimension() const override { return fElements.size(); }
